<%-- 
    Document   : adauga_Carti
    Created on : Jan 19, 2019, 9:36:58 PM
    Author     : raddu
--%>
...
<body class="text-center" style="background-image: url(images/adauga1-2.jpg);
...
<font size="3">
        <div id="add">
            ...
            <form action="CartiController" method="GET">
                <table>
                    <tr>
                        <td> Nume Carte: </td>
                        <td><input type="text" name="NumeCarte"></td>
                    </tr>
                    <tr>
                        <td> Editura Carte: </td>
                        <td><input type="text" name="EdituraCarte"></td>
                    </tr>
                    <tr>
                        <td>  ISBN: </td>
                    ...
                    <tr>
                        <td><input type="submit" name="adaugaCarti" value="Adauga"></td>
                    </tr>
                </table>
            </form>
        </div>
        ...
        <form action="CartiController" method="POST">
            <input type="submit" name="afiseazaCarti" value="Afiseaza"> &nbsp; &nbsp;<br>
        </form>
        <br>
